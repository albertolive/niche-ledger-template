...
export function ArticleCard({ article }: { article: ArticleMeta }) {
  return (
    <Link
      ...
      className="group flex h-full flex-col rounded-xl border border-neutral-200 bg-white p-5 transition-all hover:border-emerald-300 hover:shadow-sm dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-emerald-800"
    >
